...
Another alternative would be to let the customer create is own grafana dashboard and then create the configmap with the exported JSON. This require some knowledge about the different metrics and about prometheus query language. This alternative is already possible for the customer.
