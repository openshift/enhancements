...
one that can support the EVPN feature:
...
this configuration will be introduced in a future enhancement.
...
expected to match the existing coverage for P-CUDNs when configured normally,
except for features explicitly identified as unsupported in the EVPN upstream
[enhancement][10]
...
* A mix of scenarios where the EVPN underlay is carried over br-ex or secondary
  interfaces
* testing upgrades from a cluster already making use of the EVPN feature.
* day-0 EVPN configurations
