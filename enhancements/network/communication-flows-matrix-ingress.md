...
- Release-informing/blocking jobs will be added
  - Comprehensive firewall rules validation test as described in the Implementation Details section
    ([implemented](https://github.com/openshift-kni/commatrix/blob/main/test/e2e/commatrix_suite_test.go#L100))
