...
Job queueing abd batch scheduling style workloads are popular in the Kubernetes community.
...
* The hosted control plane operator will install the `provisioningrequests.autoscaling.x-k8s.io`
  resource definition in guest cluster.
...
1. Unauthorized creation of infrastructure resources. Because the ProvisioningRequest
  ...
  ProvisioningRequests could lead to the creation of infrastructure resources.
