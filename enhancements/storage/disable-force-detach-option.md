...
Note though that `hostedCluster.spec.configuration` only contains v1 API types (compatibility level 1). The new ControllerManager API will have to be promoted to v1 before it can land there with the hypershift implementation.
...
- API promoted to v1.
- Hypershift support implemented.
