...
| -             | -               | x            | no configuration                                                 |
| -             | x               | -            | required (must not be install namespace)                         |
| -             | x               | x            | optional (default: install namespace)                            | 
| x             | -               | -            | no configuration                                                 | 
| x             | -               | x            | optional. If set, must be install namespace (default: unset)     | 
| x             | x               | -            | optional. If set, must NOT be install namespace (default: unset) | 
| x             | x               | x            | optional (default: unset)                                        | 
