...
replaces:
  - https://github.com/openshift/enhancements/pull/1749
superseded-by:
  - N/A
---
...
**Implement constraints on FBC structure:** Explicitly defining minimum content constraints on FBC unpacked by catalogd so as to ensure an immutable interaction for any interrogation via this service.  This is rejected because not all catalogs will have the same set of expectations for minimum content, and because the focus of this feature is to disintermediate FBC producers and consumers without requiring continued maintenance work or perfect future knowledge.  Minimum content constraints and change attributes (scope, tempo, etc.) remain a contract between FBC producers/consumers unchanged by and outside the scope of this service.
