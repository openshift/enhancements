...
- **Azure Blob**: `encryptionKeyURL` in `HCPEtcdBackupAzureBlob` — when set, the `etcd-upload` subcommand configures customer-managed key (CMK) encryption on the blob upload.
