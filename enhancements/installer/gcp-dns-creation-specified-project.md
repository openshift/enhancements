...
- Provisioning and/or configuring the public DNS zone. When the user specifies the
  project for the private DNS Zone, the public zone must exist in the same project
...
the Specified Second Service Project.
...
_Note:_ This permission may be overly permissive for certain customers. We can address these concerns
as HIVE has also run into overly permissive service account rules in the past.

### Risks and Mitigations

Overly or too broad of permissions used. This has affected several teams and customers in the 
past. We really need to drill down the minimal permissions and document why they are required
for the future.
