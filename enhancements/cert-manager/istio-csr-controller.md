...
type IstiodTLSConfig struct {
	...
	// when not set. commonName must not exceed 64 characters.
	...
	// is RSA are 2048, 4096, 8192; and for ECDSA, they are 256, 384.
...
type ConfigMapReference struct {
	...
	// namespace in which the ConfigMap exists. If empty, ConfigMap will be looked up in the operator's namespace.
	// +kubebuilder:validation:MinLength:=1
	// +kubebuilder:validation:MaxLength:=63
