...
The client oc adm upgrade status code that interprets the API to human-readable output will receive similar integration example-based tests as the client-based implementation.
