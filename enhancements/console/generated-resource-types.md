...
2. Where should the type generation library be maintained? Should it be part of
   ...
   - A separate repository could be beneficial for modularity and ease of
     maintenance, while being part of `openshift/api` could ensure that TypeScript
     is a first-class citizen in the OpenShift ecosystem.
