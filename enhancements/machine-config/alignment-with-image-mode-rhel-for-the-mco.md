...
* Discussion question for gaps highlighted in phase 2 
    ...
    - A: 
        ...
        - For the time being, the MCO will have to keep some of the file writing workflow in place until bootc can support this. Timeline for when bootc will be able to add this support is to be determined. 
...
There are three cases we should consider and try to support under tech preview
  * Scenario 1: We don’t have layered update path as the default, but we start to provide rpm-ostree + bootc dual support (likely in 4.17 and 4.18)
...
* The GA of this enhancement is also dependent on:
    ...
    - Split RHCOS into Layers & Image Compose 
    - Move to dnf Interface for RHCOS Package Install 
    - Local Package Layering on Bootc-based RHCOS 
* The GA of this enhancement will work with a dual-stream RHCOS 
